                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-edit2"></span><span class="mtext">Category Manager</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-library"></span><span class="mtext">Book Mannager</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-library"></span><span class="mtext">Contact Mannager</span>
                        </a>
                        <ul class="submenu">
